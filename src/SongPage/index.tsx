...
const SongPage = (props: SongPageProps) => {
  ...
  useEffect(() => {
    // if (document.getElementById('audio-1')) {
    //   audioRef.current = document.getElementById('audio-1');
    // }
    // if (document.getElementById('lyrics-1')) {
    //   lyricsRef.current = document.getElementById('lyrics-1');
    // }
  ...
  return (
    <>
      <audio id="audio-1" controls ref={audioRef}>
        <source src="https://github.com/volodyathehurricane/karaoke-back/raw/master/songs/kuznechik.mp3" type="audio/mpeg"/>
      </audio>
